## データソース（Raw Data Sources）

本プロジェクトでは、以下の公的統計データを需要側の時系列データとして使用しています。
...
### 補足
- 元データは再配布制限および容量の観点から、本リポジトリには同梱していません
- 上記リンクより取得したCSVを `data/raw/` 配下に配置してください
- 取得後、Notebookを上から順に実行することで分析結果を再現できます
